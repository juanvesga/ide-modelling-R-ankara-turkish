...
```{r echo=FALSE}
data_example <- data.frame(vector_character, vector_double[1:4], vector_logic, vector_integer)
data_example
new_vec<-data_example[2,3]
```  
...
```{r echo=FALSE}
get_bmi<- function(weight,height){ # function definition and arguments
  
bmi<- weight/height^2
    return(bmi)
}

patients<-c(get_bmi(96,1.83),get_bmi(78,1.65),get_bmi(99,1.98))
patients
```
